...
const PortfolioSinglePage = (props) => {
    ...
    return (
        <Fragment>
            ...
            <PageTitle pageTitle={portfolioDetails.cTitle} pagesub={'Project'} />
                        ...
                        <div className="col-lg-8 col-md-12">
                            <div className="wpo-service-single-wrap">
                                <div className="wpo-service-single-img">
                                    <img src={portfolioDetails.pImg} alt="" />
                                </div>
                                ...
                                <div className="wpo-service-single-content">
                                    <div className="wpo-service-single-content-des">
                                        ...
                                        <div className="wpo-service-single-sub-img">
                                            <ul>
                                                <li><img src={portfolioDetails.ssImg1} alt="" /></li>
                                                <li><img src={portfolioDetails.ssImg2} alt="" /></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
